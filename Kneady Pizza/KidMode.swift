...
enum KidLibrary {
    ...
    static let peppers    = KidTopping(name: "Peppers", emoji: "🫑", kidAmount: "colourful pepper strips", grownupTip: "chop small and thin", veggie: true, video: "kid-topping-peppers")
    ...
    static let banana     = KidTopping(name: "Banana", emoji: "🍌", kidAmount: "banana coins", grownupTip: "slice nice and thin", veggie: true, video: "kid-topping-banana")
